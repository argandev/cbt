          ...
          <div class="p-2 px-6 leading-snug rounded">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center">
              <div class="grid grid-cols-1 gap-2 tracking-tighter">
                ...
                <div>
                  <div class="font-semibold">Kelas(Group):</div>
                  XII-RPL 10
                </div>
                <div>
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    <span>/</span>
                    <div
                      v-if="(jumlah_soal = jadwalStore?.available?.data?.bank_soal?.jumlah_soal)"
                    >
                      {{ jumlah_soal }} Soal
                    </div>
                    <div v-else>loading...</div>
              ...
              <div class="my-4 font-bold text-green-500 sm:my-0">Sesi 1 Jam Ke 2</div>
            </div>
          </div>

          <div class="p-4 px-6 py-2">
            <div v-if="jadwalStore?.available?.data?.settings?.token">
              <label for="token" class="font-semibold text-gray-200">Token</label>
              <InputText
                v-model="form.token"
                class="w-full py-3 rounded-sm bg-gray-50 h-9"
            ...
            <div class="flex justify-start mb-6">
              ...
              />
              <div
                class="block w-full p-3 tracking-tighter text-center bg-gray-100 border border-gray-400 rounded"
                v-else
              >
